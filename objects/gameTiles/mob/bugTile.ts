...
export class BugTile implements MobTile {
  value;
  id: string;
  direction: number;
  speed = 2;
  ...
  private setValueFromDirection() {
    switch(this.direction) {
      case (Constants.DIRECTION_UP): this.value = Constants.MOB_BUG_UP; break;
      case (Constants.DIRECTION_LEFT): this.value = Constants.MOB_BUG_LEFT; break;
      case (Constants.DIRECTION_DOWN): this.value = Constants.MOB_BUG_DOWN; break;
      case (Constants.DIRECTION_RIGHT): this.value = Constants.MOB_BUG_RIGHT; break;
    }
  }
}
