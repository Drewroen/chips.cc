...
export class TankTile implements MobTile {
  ...
  private setValueFromDirection() {
    switch(this.direction) {
      case (Constants.DIRECTION_UP): this.value = Constants.MOB_TANK_UP; break;
      case (Constants.DIRECTION_LEFT): this.value = Constants.MOB_TANK_LEFT; break;
      case (Constants.DIRECTION_DOWN): this.value = Constants.MOB_TANK_DOWN; break;
      case (Constants.DIRECTION_RIGHT): this.value = Constants.MOB_TANK_RIGHT; break;
    }
  }
}
